...
integration-test:
	python3 ./tests/integration/run.py run ./tests/integration/cases/...

.PHONY: integration-test-docker
integration-test-docker:
	python3 ./tests/integration/run.py run --macaron scripts/release_scripts/run_macaron.sh --include-tag docker ./tests/integration/cases/...
